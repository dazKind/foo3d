...
class GLES3RenderDevice extends AbstractRenderDevice {
    var oldFbo:Int;
...
extern class GL {
    ...
    inline public static function init(_caps:RDIDeviceCaps):Void {
        ...
        _caps.texFloatSupport = true; //untyped __cpp__("GLEW_ARB_texture_float==1");
        _caps.texNPOTSupport = true; //untyped __cpp__("GLEW_ARB_texture_non_power_of_two==1");
        _caps.rtMultisampling = true; //untyped __cpp__("GLEW_EXT_framebuffer_multisample==1");
        _caps.drawInstancedSupport = true; //untyped __cpp__("GLEW_ARB_instanced_arrays==1");
    ...
    inline public static function drawBuffer(_mode:Int):Void {
        if (_mode == GL.BACK)
            untyped __cpp__("glDrawBuffers(1, foo3d::buffer_back)");
        else
            untyped __cpp__("glDrawBuffers(1, foo3d::buffer_none)");
    }
    ...
    inline public static var BACK:Int = 0x0402;
