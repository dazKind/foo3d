...
class GLES2RenderDevice extends AbstractRenderDevice {
    ...
    override function init():Void {
        ...
        oldFbo = GL.getIntegerv(GL.FRAMEBUFFER_BINDING);
    }
    ...
    override public function createTexture(_type:Int, _width:Int, _height:Int, _format:Int, _hasMips:Bool, _genMips:Bool, _isCompressed:Bool):Int { 
        /* TODO: review this, with renderbuffers this obv doesnt hold up true!
    ...
    override public function uploadTextureData(_handle:Int, _slice:Int, _mipLevel:Int, _pixels:PixelData, ?_formatOverride:Int=0, ?_typeOverride:Int=0, ?_imageSize:Int=0):Void {
        ...
        if (_pixels == null) {// we wanna upload an empty buffer
            ...
            GL.texImage2D(target, _mipLevel, inputFormat, width, height, 0, inputFormat, inputType, null);
        } else {
    ...
    override public function createRenderBuffer(_width:Int, _height:Int, _format:Int, _depth:Bool, ?_numColBufs:Int=1, ?_samples:Int = 0):Int { 
        ...
        {
            GL.bindFramebuffer(GL.FRAMEBUFFER, rb.fbo);
            var texObj:Int = this.createTexture(RDITextureTypes.TEX2D, rb.width, rb.height, GL.DEPTH24_STENCIL8, false, false, false);
        ...
        switch(status)
        {
            case GL.FRAMEBUFFER_UNSUPPORTED: throw "Framebuffer is not supported";
    ...
    override public function destroyRenderBuffer(_handle:Int):Void {
        ...
        if (rb.depthBufObj != null) 
            GL.deleteRenderbuffer(rb.depthBufObj);
        rb.depthBufObj = null;
...
extern class GL {
    ...
    inline public static function init(_caps:RDIDeviceCaps):Void {
        ...
        _caps.texFloatSupport = untyped __cpp__("GL_OES_texture_float == 1");
        _caps.texNPOTSupport = false;
        _caps.rtMultisampling = false;
        _caps.drawInstancedSupport = false;

        var val:Int = 0;
        untyped __cpp__('glGetIntegerv(GL_MAX_VERTEX_ATTRIBS, &{0})', val);
        _caps.maxVertAttribs = val;
        
        untyped __cpp__('glGetIntegerv(GL_MAX_VERTEX_UNIFORM_VECTORS, &val)');
        _caps.maxVertUniforms = val;

        untyped __cpp__('glGetIntegerv(GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS, &val)');
        _caps.maxTextureUnits = val;

        _caps.maxColorAttachments = 1;
    }
    ...
    inline public static function drawElementsInstanced(_primType:Int, _type:Int, _numInds:Int, _offset:Int, _primCount:Int):Void
        untyped __cpp__("glDrawElementsInstancedEXT({0}, {1}, {2}, (const void*)({3}), {4})", 
    ...
    inline public static function renderbufferStorage(_format:Int, _width:Int, _height:Int):Void
        untyped __cpp__("glRenderbufferStorage(GL_RENDERBUFFER, {0}, {1}, {2})", _format, _width, _height);
    ...
    inline public static var RG:Int = 0x8227;
    ...
    inline public static var DEPTH_COMPONENT16:Int = 0x81A5;
    ...
    inline public static var FRAMEBUFFER_INCOMPLETE_DIMENSIONS:Int = 0x8CD9;
    ...
    inline public static var RGBA16F_EXT:Int = 0x881A;
    inline public static var RGB16F_EXT:Int = 0x881B;
    inline public static var RG16F_EXT:Int = 0x822F;
    inline public static var R16F_EXT:Int = 0x822D;
